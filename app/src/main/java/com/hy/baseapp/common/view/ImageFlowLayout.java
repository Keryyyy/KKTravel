...
import com.hy.baseapp.common.extension.GlideKt;
...
public class ImageFlowLayout extends ViewGroup {
    ...
    private int spWidth = ConvertUtils.dp2px(22);
...
//                modeHeight == MeasureSpec.EXACTLY ? sizeHeight : height);
        ...
        //修复每增加一个头像最右边的margin right值就会增加的问题
...
//            Collections.reverse(lineViews);
    ...
    private void setViews() {
        ...
        for (int i = 0; i < allUrls.size(); i++) {
            ...
            ConstraintLayout rootView = (ConstraintLayout) LayoutInflater.from(context).inflate(R.layout.item_praise, this, false);
            ImageView imageView = rootView.findViewById(R.id.iv_content);

            //后台有时候会回来null
            if (allUrls.get(i) != null){
                GlideKt.display(imageView,allUrls.get(i));
            }
